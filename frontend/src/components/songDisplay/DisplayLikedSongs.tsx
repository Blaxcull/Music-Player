      ...
      <div className="p-6 border-b border-gray-100">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={() => {
              const wasLikedSongs = queueName === "likedSongs";
      ...
      <div className="px-6 py-4">
        <ul className="w-full select-none">
          <li className="pl-2 text-gray-500 text-sm mb-2 flex items-center">
            ...
            <span className="w-20 flex-shrink-0 text-right pr-6">
              Duration
            </span>
          </li>
          ...
          {songs.map((song, index) => (
            <li
              key={song._id}
              className="group flex items-center py-2 text-gray-900 text-sm hover:bg-gray-50 transition-colors rounded-lg"
            >
              ...
              <span className="flex-[2] min-w-[120px] text-gray-600">
                {song.Artist}
              </span>

              <span className="flex-[2] min-w-[120px] text-gray-500">
              ...
              <span className="w-20 flex-shrink-0 text-right text-gray-500 pr-6">
